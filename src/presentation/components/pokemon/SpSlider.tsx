    ...
    <div className="space-y-0.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <input
          ...
          className="flex-1 min-w-0 h-2 bg-slate-700 rounded-lg appearance-none cursor-pointer accent-blue-500"
        ...
        <div className="flex items-center justify-end gap-2 pl-5">
          {hasRank && (
            <div className="flex items-center gap-0.5">
              <button
                type="button"
                className="w-5 h-5 text-xs bg-slate-700 hover:bg-slate-600 active:bg-slate-500 rounded text-slate-300 leading-none flex-shrink-0"
