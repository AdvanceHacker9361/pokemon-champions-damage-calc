      ...
      <header className="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 sm:px-4 py-2.5 sm:py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          <h1 className="text-sm sm:text-lg font-bold text-slate-900 dark:text-slate-100 leading-tight">
            ...
            <span className="ml-1.5 text-xs sm:text-sm font-normal text-slate-500 dark:text-slate-400">ダメージ計算</span>
          </h1>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400 dark:text-slate-600 font-mono flex-shrink-0">v{APP_VERSION}</span>
          </div>
        </div>
      </header>
      <main>
